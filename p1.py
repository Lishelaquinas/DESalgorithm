...
def encrypt2():
    ...
    for i in range(0, 30):
        ...
        if i not in key and len(key) <= 15:
            key.append(i)
    print("KEY2")
    print(key)


def shuffle(cipher_text):
    global ct2
    ct2 = []
    for i in range(0, 32):
        ct2.append(-1)
...
pt = input("Enter the plain text(16 bit hexa decimal)")
key = input("Enter the key(16 bit hexa decimal)")
print("PLAIN TEXT: ", pt)
print("KEY: ", key)
...
encrypt2()
ct2 = shuffle(cipher_text)
key2 = padding(ct2)
print("NEW CIPHER ", key2)

cipher_text = decypt_key(key2)
print("Decryption")
rkb_rev = rkb[::-1]
rk_rev = rk[::-1]
